...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\jatan\PycharmProjects\selenium_py_test_graduation\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\jatan\PycharmProjects\selenium_py_test_graduation\venv\Scripts\deactivate.nu'
